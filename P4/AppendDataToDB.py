...
connectionString = "Driver={ODBC Driver 18 for SQL Server};Server=tcp:p4passwordmanager.database.windows.net,1433;Database=P4PasswordManager;Uid={Your_Username_Here};Pwd={Your_password_here};Encrypt=yes;TrustServerCertificate=no;Connection Timeout=30;"
